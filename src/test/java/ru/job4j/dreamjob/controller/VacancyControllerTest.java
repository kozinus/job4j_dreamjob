...
public class VacancyControllerTest {
    ...
    @Test
    public void whenRequestVacancyToDeleteThenRedirectToVacancies() {
    ...
    @Test
    public void whenRequestVacancyToDeleteThenGetErrorPage() {
    ...
    @Test
    public void whenRequestVacancyIdThenGetPageWithOneVacancy() {
    ...
    @Test
    public void whenRequestVacancyIdThenGetErrorPage() {
        var model = new ConcurrentModel();
        var view = vacancyController.getById(model, 1);
        var message = model.getAttribute("message");
